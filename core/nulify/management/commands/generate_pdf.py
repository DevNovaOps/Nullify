...
class Command(BaseCommand):
    help = 'Generates PDF documentation from Markdown'
    ...
    def handle(self, *args, **options):
        ...
        in_path = r'c:\Users\Dev\Desktop\Nullify_Setup_Documentation.md'
        ...
        doc.build(story)
        self.stdout.write(self.style.SUCCESS(f'Successfully generated PDF at {out_path}'))
